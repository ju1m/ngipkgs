...
#
beamCopySourceHookNonDeterministic() {
  echo "Executing beamCopySourceHookNonDeterministic"
  ...
  echo "Finished beamCopySourceHookNonDeterministic"
}

postUnpackHooks+=(beamCopySourceHookNonDeterministic)
